package com.example.mybase20190512.net.interceptors;

import com.example.mybase20190512.app.GlobalConfig;
import com.example.mybase20190512.util.NetworkUtils;
...
public class AddCacheInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (!NetworkUtils.isAvailable(GlobalConfig.getApplicationContext())) {
